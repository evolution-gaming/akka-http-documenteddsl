...
trait ParameterDDirectives {
  ...
  case class Param[T: ru.TypeTag](
    ...
    def describe(
      ...
      as: AutoSchema,
    ): RouteDocumentation = w.parameter[T](name, required = true, origin = ParamDocumentation.Origin.Query)
  ...
  case class OptParam[T: ru.TypeTag](
    name: String,
  )(implicit
    su: PreprocessedFromStringUnmarshaller[T],
    ...
    def describe(
      ...
      as: AutoSchema,
    ): RouteDocumentation = w.parameter[T](name, required = false, origin = ParamDocumentation.Origin.Query)
  ...
  case class DefaultParam[T: ru.TypeTag](
    name: String,
    default: T,
  )(implicit
    su: PreprocessedFromStringUnmarshaller[T],
